<template>
  ...
  <div class="name" :class="{ size: changeNameBol }">{{ loginName }}</div>
  <a-button type="primary" @click="changeName" danger
    >我是让他变傻的按钮</a-button
  >
</template>
